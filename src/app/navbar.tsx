...
const Navbar = () => {
  ...
  const scrollTo = () => {
    ...
    const navbarHeight =
      ref1.current?.getBoundingClientRect().height === 297.5
        ? 60
    ...
    window.scrollTo({
      ...
      top:
        navbarHeight &&
        projectCoord?.top &&
        projectCoord.top + window.scrollY - navbarHeight,
      behavior: "smooth",
    });
  };
  ...
  return (
    <section
      onClick={checkNav}
      ref={ref1}
      className="lg:px-24 lg:h-16 lg:items-center pt-2 flex lg:flex-row flex-col fixed top-0 left-0 right-0 z-30 bg-white "
    >
      ...
      <div
        onClick={checkNav}
        className={`${
          openNavBar ? "bg-darkGreen h-64 text-white " : " h-0"
        } shadow-md transition-all delay-400 duration-300 lg:h-0 w-full lg:text-black lg:bg-white `}
      >
        ...
        <Link  href="/about">
          <li
            ...
            } hover:lg:bg-darkGreen hover:lg:text-white lg:block ${
              state.aboutIsActive && "lg:bg-darkGreen lg:text-white "
            } text-white lg:text-gray-900 lg:h-8 lg:w-20 lg:text-center lg:flex lg:items-center lg:justify-center transition-all delay-400 duration-300`}
          ...
          <div
            ...
            className={`${
              pathname !== "/"
                ? "hidden"
                : "lg:lg:h-8 lg:w-20 lg:text-center lg:flex lg:items-center lg:justify-center"
            } hover:lg:bg-darkGreen hover:lg:text-white text-white lg:text-gray-900 cursor-pointer transition-all delay-400 duration-300 ${
              openNavBar && pathname == "/" ? "visible" : "hidden"
            } ${state.projectsIsActive && "bg-darkGreen text-white"} `}
          >
            <li onClick={() => navBarHandler("projects")}>Projects</li>
          </div>
          <Link href="/donate">
          <li
            className={`${
              ...
              state.donateIsActive && "lg:bg-darkGreen lg:text-white"
          ...
          <li
            className={`${
              ...
              state.contactIsActive && "lg:bg-darkGreen lg:text-white"
            } lg:text-gray-900 text-white lg:h-8 lg:w-20 lg:text-center lg:flex lg:items-center lg:justify-center transition-all delay-400 duration-300`}
