...
import aboutB from "../../../public/about/aboutb.webp";
      ...
      <section className="lg:grid lg:grid-cols-2 lg:px-24 lg:w-full lg:pt-6  ">
        ...
        <article className="">
          <div className="flex font-light indent-8 px-2 flex-col space-y-3 mt-4 lg:mt-0 text-sm ">
            ...
            <p className=" ">
              We have since focused on making impact in Education, Healthcare,
              empowering people particularly the youths and widows with skills
              and various other support to enable them live a meaningful and
              sustainable life.
            </p>

            <p>
              We have been working with the following aims and objectives in
              mind:
            </p>
          </div>

          <div className="px-3 font-light text-sm ">
            <li>To provide social amenities to communities in need.</li>
            <li>
              To empower rural children with educational materials and
              facilities such as library and class rooms
            </li>
            <li>
              To provide health facilities, medications and preventive measures
              to tackle sicknesses like Malaria, HIV/AIDS, tuberculosis and
              other deadly diseases in communities and refugee camps.
            </li>
            <li>
              To provide scholarship/financial aid to less privileged and
              disadvantaged areas.
            </li>
            <li>
              To provide support under health and nutrition service for women,
              children, widows and the aged.
            </li>
            <li>
              To provide support for people affected by natural disasters such
            ...
            <li>
              To raise funds through donations, partnership and make investments
              that will bring about the achievement of the aims of ZION EMINENT
              TRUST FOUNDATION.
            </li>
            <li>
              To provide skill acquisition training for graduate and
              undergraduate on vocational skills and ICT.
            </li>
            <li>
              To be involved in any other assignment or work that may be
              beneficial to the welfare of the general public
            </li>
          </div>
