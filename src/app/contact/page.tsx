  ...
  return (
    <section className="lg:px-24 lg:pt-8">
      ...
      <Image
        ...
        alt="Zet foundation's contact page"
      />
      <article className="font-quickSand flex flex-col lg:flex-row lg:text-sm py-10 lg:space-y-0 space-y-8 justify-around">
        <div className="text-center lg:text-start ">
          <span className="font-bold">Head Office Address</span>
          <p>
            No 4, Opposite ECWA Church Osere, Irewolede Area, <br className="lg:block hidden"/>Ilorin, Kwara
            State, Nigeria.
          </p>
        </div>
        <div className="text-center lg:text-start">
        ...
        <div className="text-center lg:text-start">
          ...
          <div className="flex flex-row items-center  lg:justify-start justify-center gap-x-2">
