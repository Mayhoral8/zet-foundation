...
import contactWeb from '../../../public/contact/contact-web.png'
    ...
    <section className='lg:px-24 lg:pt-8'>
      ...
      <article className='font-quickSand flex flex-col py-10 space-y-8 justify-around'>
        <div className='text-center'>
          ...
          <p>No 4, Opposite ECWA Church Osere, Irewolede Area, Ilorin, KWara State, Nigeria.</p>
        </div>
        <div className='text-center'>
        ...
        <div className='text-center'>
          ...
          <div className='flex flex-row items-center justify-center gap-x-2'><FaFacebook/> zetfoundation</div>
          <div className='flex flex-row items-center justify-center gap-x-2'><FaInstagram/> zet_foundation</div>
          <div className='flex flex-row items-center justify-center gap-x-2'><FaXTwitter/>@zetfoundation24</div>
