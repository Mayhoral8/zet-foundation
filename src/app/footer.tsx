...
const Footer = () => {
  return (
    <section className='bg-darkGreen flex items-center flex-col text-white mt-8 h-[380px] justify-around lg:px-40'>
...
/>
<span className='text-xs hidden lg:block lg:mt-2 quote2'>The beauty of life does not depend on how happy you are, <br/><span className='font-light'> but on how happy others can be because of you</span></span>
</div>
<div className='text-center lg:text-start lg:mr-28'>
<h3 className='text-sm lg:text-base'>Head Office Address</h3>
<span className='font-thin text-xs  text-center  leading-1'>No 4, Opposite ECWA Church Osere, Irewolede Area, <br/> Ilorin, Kwara State, Nigeria.</span>
</div>
</article>
