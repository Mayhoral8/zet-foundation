...
export default function Home() {
  const { ref2} = useContext(ContextCreate)
  ...
  return (
    <main>
      <section
        className={` ${quicksand.className} pt-16 lg:pt-14  font-quickSand font-bold  px-3 antialiased`}
      >
              ...
              <article className="flex flex-row justify-around lg:justify-end lg:space-x-20 mt-[-130px] lg:mt-0 items-center w-full">
                <div className="w-2/5  lg:w-2/6 rounded-lg mt-16 lg:mt-4  shadow-lg">
                  ...
                  <button
                    ...
                    data-aos-duration="1200"
                    data-aos-once="true"
                    className=" z-20 animate-bounce text-regular lg:space-x-2 bg-white text-center mx-auto font-medium lg:h-14 h-12 w-32 ml-16  items-center absolute lg:w-40 lg:left-auto lg:ml-40 lg:mt-[-12px] mt-[-20px] rounded-xl  left-0  flex flex-row justify-center  shadow-lg"
                  >
          ...
          <section className=" w-full flex flex-col justify-between space-y-8 mt-10 ">
            <div className="font-medium quote text-center lg:text-start">
              <p className=" font-bold lg:w-full md:text-2xl lg:text-4xl ">
                ...
                <span className="font-medium">
                  ...
                  <br className="hidden lg:block" /> can be because of you.
                </span>{" "}
              </p>
            </div>
            ...
            <article className="mt-8 space-y-2 items-center flex flex-col justify-center lg:justify-start lg:flex lg:flex-row  lg:space-x-2">
              ...
              <div className=" text-center lg:text-start">
                <span className="">
                  Jarumi<span className="font-light ml-1">Thomas</span>
                </span>
                <p className="font-light text-sm">
                  Chairman/Founder ZET Foundation
                </p>
              </div>
            </article>
          </section>
        ...
        <section className="lg:grid lg:grid-cols-2 lg:justify-center lg:items-center ">
          ...
          <section className="grid grid-rows-2 h-96 lg:items-center lg:space-y-32 lg:justify-center mt-8 lg:mt-0 w-full">
            <article
              ...
              data-aos-once="true"
            >
              <span className="  flex flex-row items-center lg:text-lg w-full space-x-4 justify-center text-center">
                Our Vision <TbBulb />{" "}
              </span>
              <div className="w-[320px] lg:w-[500px] h-28 lg:h-40 border font-light px-4 leading-relaxed text-start rounded-2xl  flex items-center mx-auto bg-lightGreen">
                <p className="text-sm lg:text-base">
                  To Empower Lives, Transform Communities, and create a world
                  where every individual thrives in Dignity, Equality, and Hope
                </p>
              </div>
            </article>
            <article
              ...
              data-aos-once="true"
            >
              <span className=" flex flex-row items-center lg:text-lg space-x-4 justify-center text-center">
        ...
        <section className="w-full lg:mt-8 lg:flex lg:flex-col lg:justify-evenly bg-darkGreen lg:h-[600px]">
          <div>
            ...
            <p className=" text-white font-light px-4 text-sm lg:text-base mt-5 leading-relaxed lg:px-40 lg:text-center">
              ZION EMINENT TRUST FOUNDATION is a non-profit organization
              dedicated to providing humanitarian aids through donations to the
              less privileged and communities in Nigeria and has since been
              committed to making a positive by donating out several educational
              materials to less privileged students, by supporting widows with
              food stuff and other basic provisions and also educating local
              communities on basic hygiene and health care information needed to
              maintain a safe and healthy growth for their children and for
              themselves.
            </p>
          </div>
          ...
          <article className="flex flex-col items-center justify-center space-y-4 mt-4 py-2">
            ...
            >
              <div className="w-[320px] min-[667px]:w-[280px] h-28 py-2 border lg:h-40 font-light px-3 text-start rounded-2xl flex flex-col justify-around mx-auto bg-lightGreen ">
                ...
                <p className="text-xs">
                  We provide educational materials to support students in
                  schools particularly rural areas.
                </p>
              </div>
              <div
                data-aos="fade-down"
              ...
              >
                ...
                <p className="text-xs">
                  We provide various aids in form of food items, medicines and
                  also organize some health talks to help reduce health
                  challenges our society is faced with.
                </p>
              </div>
            </div>
            ...
            >
              <div className="w-[320px] min-[667px]:w-[280px] h-28 py-2 border lg:h-40 font-light px-3 text-start rounded-2xl flex flex-col justify-around mx-auto bg-white ">
                ...
                <p className="text-xs">
                  We organize skill acquisition programs with fund raising to
                  support and empower beneficiaries
                </p>
              </div>
              <div
                data-aos="fade-up"
                ...
                data-aos-duration="1200"
                data-aos-once="true"
                className="w-[320px] h-28 py-2 border lg:h-40 font-light px-3 text-start rounded-2xl flex flex-col justify-around mx-auto bg-white "
              >
                <h2>
                  <LiaPeopleCarrySolid />
                </h2>
                ...
                <p className="text-xs">
                  We provide financial aids, Food and provisions as well as
                  advocacy for the less privileged in our society
                </p>
              </div>
            </div>
          </article>
        ...
        <section ref={ref2} className="mt-8">
          ...
          <article className="flex flex-col lg:justify-center lg:flex-col lg:w-full lg:items-center space-y-8 py-3">
            ...
            <div className="lg:flex flex-col space-y-5 lg:space-y-0 lg:flex-row lg:space-x-8 lg:justify-center">
              <div
                data-aos="fade-up"
                data-aos-easing="ease-out"
                data-aos-duration="1200"
              ...
              >
                ...
                <p className="text-xs lg:px-10 font-normal lg:mt-4 text-center">
                  Outreach to Pupils of Wesley Primary School, Yidi Road,
